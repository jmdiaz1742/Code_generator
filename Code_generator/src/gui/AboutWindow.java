...
public class AboutWindow {
	...
	public void setVisible(boolean status) {
		this.frmAboutCodeGenerator.setVisible(status);
	}
	...
	private void initialize() {
		...
		String version = Features.SW_VERSION + ", codename: " + Features.VERSION_NAME;
		...
		frmAboutCodeGenerator.setBounds(100, 100, 450, 300);
